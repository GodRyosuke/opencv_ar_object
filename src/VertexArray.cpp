...
// 3D skined mesh
VertexArray::VertexArray(std::vector<glm::vec3>positions, std::vector<glm::vec3> normals, std::vector<glm::vec2> texcoords, std::vector<glm::vec3> tangents, std::vector<unsigned int> indices, const class Skeleton* skeleton)
{
glGenVertexArrays(1, &mVertexArray);
    glBindVertexArray(mVertexArray);
